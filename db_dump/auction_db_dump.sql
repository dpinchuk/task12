...
CREATE TABLE `bids` (
  ...
  CONSTRAINT `buyer_id` FOREIGN KEY (`buyer_id`) REFERENCES `buyers` (`buyer_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `bids` VALUES (1,100,2200,4,1),(2,50,1250,1,2),(3,1000,12000,3,7),(4,100,2200,4,4),(5,100,4000,2,3);
...
CREATE TABLE `products` (
  ...
  CONSTRAINT `seller_id` FOREIGN KEY (`seller_id`) REFERENCES `sellers` (`seller_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `products` VALUES (1,'Table-1890',2000,NULL,1),(2,'Chair-1888',1200,NULL,1),(3,'Knife-235',3800,NULL,2),(4,'Coin-380',5000,NULL,1),(5,'Mark-1809',2400,NULL,2),(6,'Mirror-1722',12400,NULL,1),(7,'Earring-144',8000,NULL,2);
...
-- Dump completed on 2017-08-12  1:07:14
